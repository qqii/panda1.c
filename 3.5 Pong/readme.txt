Terminal Pong Clone with Strange Input using ncurses
	Pong
		...
		Taken from https://en.wikipedia.org/wiki/Pong#Gameplay

	Usage:
		Compile the program using the included compile.sh bash script. This will also automatically run the output file "pong.o".
