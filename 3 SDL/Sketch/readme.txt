...
I have included zipped files for sketch and decode, both just as source and with .sketch and .test files. The interpret.c and .h file exists in both zips but they are not the same.